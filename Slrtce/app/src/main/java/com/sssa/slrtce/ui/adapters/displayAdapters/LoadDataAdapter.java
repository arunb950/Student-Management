...
public class LoadDataAdapter extends BaseRecyclerViewAdapter<Result, LoadDataAdapter.loadViewholder> {
    ...
    public class loadViewholder extends RecyclerView.ViewHolder {
        ...
        public loadViewholder(View itemView) {
            ...
            syllabus_count = itemView.findViewById(R.id.syllabus_count);
            syllabus_title = itemView.findViewById(R.id.syllabus_title);
            syllabus_dtime = itemView.findViewById(R.id.syllabus_dtime);
        }
    }
}
