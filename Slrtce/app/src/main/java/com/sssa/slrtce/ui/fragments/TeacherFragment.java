...
public class TeacherFragment extends BaseFragment implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void ui(View rootview) {
        ...
        cmpn = rootview.findViewById(R.id.branch_cmpn);
        it = rootview.findViewById(R.id.branch_it);
        etrx = rootview.findViewById(R.id.branch_etrx);
        extc = rootview.findViewById(R.id.branch_extc);
        mech = rootview.findViewById(R.id.branch_mech);
        civil = rootview.findViewById(R.id.branch_civil);
