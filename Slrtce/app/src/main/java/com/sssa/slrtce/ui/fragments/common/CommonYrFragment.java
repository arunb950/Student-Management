...
public class CommonYrFragment extends BaseFragment {
    ...
    protected void ui(View rootview) {
        ...
        firstyear = rootview.findViewById(R.id.firstYear);
        secondyear = rootview.findViewById(R.id.secondYear);
        thirdyear = rootview.findViewById(R.id.thirdYear);
        fourthyear = rootview.findViewById(R.id.fourthYear);
