...
public class FourthYearFragment extends BaseFragment {
    ...
    protected void ui(View rootview) {
        ...
        dsp = rootview.findViewById(R.id.syallbus_dsp);
        mc = rootview.findViewById(R.id.syallbus_mc);
        pm = rootview.findViewById(R.id.syallbus_pm);
        sc = rootview.findViewById(R.id.syallbus_sc);
        ss = rootview.findViewById(R.id.syallbus_ss);
    }
